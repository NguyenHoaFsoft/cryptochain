...
describe('Transaction', () => {
    ...
    describe('update()', () => {
        ...
        describe('and the amount is valid', () => {
            it('thows an error', () => {
                expect(() => {
                    transaction.update({ senderWallet, nextRecipient: 'foo', nextAmount: 999999 });
        ...
        describe('and the amount is valid', () => {
            ...
            describe('and another update for the same recipient', () => {
                ...
                beforeEach(() => {
                    addedAmount = 80;
                    transaction.update({ senderWallet, nextRecipient, nextAmount: addedAmount });
                });
                ...
                it('subtracts the amount from the original sender output amount', () => {
                    expect(transaction.outputMap[senderWallet.publicKey]).toEqual(originalSenderOutputMap - nextAmount - addedAmount);
                });
            });
        });
    });
